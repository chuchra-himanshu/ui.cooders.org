  ...
  return (
    <SidebarPanelWrapper>
      <div className="flex items-center justify-between flex-wrap">
        <div className="w-[98px] mb-[8px] h-[80px] rounded-[10px] cursor-pointer transition-all ease-in-out duration-200 text-white/40 bg-white/5 hover:bg-accent/5 hover:text-accent flex flex-col items-center justify-center gap-[6px]">
          <SiMui size={26} />
