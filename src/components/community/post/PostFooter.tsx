  ...
  return (
    <div className="flex items-center justify-between mt-[10px]">
      <div className="flex items-center gap-1">
        <div className="flex items-center justify-center bg-background-primary h-[30px] w-[30px] rounded-full cursor-pointer text-text-secondary hover:bg-red-950/40 hover:text-red-600 transition-all ease-in-out duration-200">
